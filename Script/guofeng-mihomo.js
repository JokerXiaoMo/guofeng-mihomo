...
const serviceConfigs = [
  ...
  },
  {
    ...
    rules: ['RULE-SET,github,「太一」主道', 'RULE-SET,microsoft,云笈·微软'],
  },
  {
    name: '玉果·苹果',
    baseOption: selectBaseOption,
  ...
  },
  {
    ...
    rules: ['RULE-SET,steam,雾阁·蒸汽', 'RULE-SET,steam_asn,雾阁·蒸汽,no-resolve'],
  },
  {
    name: '幻音·短影',
    baseOption: selectBaseOption,
